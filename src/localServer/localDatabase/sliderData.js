...
export default [
  {
    ...
    animeId: '1',
    description: 'Третьекурсник Синъитиро Сакураи хочет наслаждаться тихой университетской жизнью, хочет быть один, но вьющаяся вокруг него Хана Удзаки не даёт ему покоя.',
    logo: Anime1Logo,
    color: '#6573d0',
  },
  {
    ...
    title: 'One Punch Man',
    animeId: '2',
    description: 'Он лысый и прекрасный. К тому же главный герой настолько силен, что с одного удара аннигилирует все опасности для человечества.',
    logo: Anime2Logo,
  },
  {
    img: Anime3,
